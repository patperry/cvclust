...
cross-validation procedure.  As in section~2.2 of the main article, we
%\ref{sec:gabriel-cv-algorithm} 
...
this fold, computed as described in Section~2.2 of the main article.
%\ref{sec:gabriel-cv-algorithm}.
...
propose in Section~4 of the main article%.~\ref{sec:corr-correct} 
attempts to transform the data to this form.
...
this result reduces to the original result of Proposition~2
of the main article %\ref{prop:twoclust}
...
Figure~8 of the main article %\ref{fig:5_clusters}
provides a more in-depth comparison with the
...
Figure~8 (main article), %\ref{fig:5_clusters},
we only include a plot for cell $(i,j)$ if the
