...
given by our proposed Gabriel method make sense. For
the brain tumours gene expression data set which is high-dimension, it is also clear that 
the correct number of clusters should be $5$, each cluster corresponding to one type of 
brain tumour. From the table we can see only our proposed
Gabriel method correctly selects $k=5$, underline how
difficult it was to pick the right $k$ when dimension is high. 
