...
Table~\ref{table:confusion}.  (Appendix~\ref{app:confusion} contains a
confusion matrix for all 30 Tavazoie clusters, including the non-interpretable
ones.) Entry $(i,j)$ of the confusion matrix gives the number of genes in
