...
\if0\blind
{
  ...
  \author{Wei Fu and Patrick O.\ Perry \hspace{.2cm} \\
...
\noindent%
{\it Keywords:} clustering, $k$-means, model selection, unsupervised learning
\vfill
...
\cmidrule(l){2-4}
Method   & Congress Voting & Breast Cancer & Brain Tumors \\
\midrule                    
Gabriel  & $2$             & $3$           & $5$  \\    
...
periodic cluster, contains genes that participate in cell-cycle processes, along
