...
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \includegraphics[width=\linewidth]{figure/elbow-correct-data.pdf}
  \end{minipage}
  \hspace{0.05in}
  \begin{minipage}{0.45\linewidth}
    \includegraphics[width=\linewidth]{figure/elbow-correct-withinss.pdf}
  \end{minipage}
\end{minipage}
\begin{minipage}{\linewidth}
  \begin{minipage}{0.45\linewidth}
    \includegraphics[width=\linewidth]{figure/elbow-incorrect-data.pdf}
  \end{minipage}
  \hspace{0.05in}
  \begin{minipage}{0.45\linewidth}
    \includegraphics[width=\linewidth]{figure/elbow-incorrect-withinss.pdf}
  \end{minipage}
\end{minipage}
...
from $1$ to $5$.  Figure~\ref{fig:null-2d-corr-equal} shows the
...
\begin{figure}
\centering
\includegraphics[width=25pc]{figure/null-2d-corr-equal.pdf}
