...
\includegraphics[width=\linewidth]{Data_example.pdf}
\end{minipage}
\hspace{0.05in}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=\linewidth]{W_k.pdf}
\end{minipage}
\end{minipage}
...
\centering
\begin{minipage}{0.45\linewidth}
\includegraphics[width=\linewidth]{Data_elbow.pdf}
\end{minipage}
\hspace{0.05in}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=\linewidth]{elbow.pdf}
\end{minipage}
\end{minipage}
