...
observations and $m$ test observations.
...
\begin{enumerate}[label={\arabic*.},leftmargin=*]
  ...
  \item The test set contains at least one member of each cluster.

  \item Each observation $i$ has a true cluster $G_i \in \{ 1, \dotsc, k \}$.
